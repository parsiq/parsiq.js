...
import {
    ...
    TsunamiBlock, TsunamiCall, TsunamiContractCreate, TsunamiContractSelfDestruct,
    TsunamiDataQueryBoundaries,
    TsunamiEvent, TsunamiRange, TsunamiTransaction, TsunamiTransactionWithLogs, TsunamiTransfer
} from "../dto";
