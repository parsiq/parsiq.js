...
export const decodeTsunamiInternalTransaction = (
    ...
    const decode = (call: TsunamiInternalTransaction,
...
const decodeTsunamiLogBasedData = (tsunamiLog: TsunamiLog | TsunamiLogWithinInternalTransaction,
    ...
    const decoded = abiInterface.decodeEventLog(
        ...
        [tsunamiLog.topic_0, tsunamiLog.topic_1, tsunamiLog.topic_2, tsunamiLog.topic_3].filter(topic => typeof topic === 'string') as string[],
    );
